...
public class TestChart {
    public static void main(String... args) {
        ...
        createGraphSheet(wb, chartSheet);
...
//the bar series
        StringBuilder positionYearCell = new StringBuilder().append("Sheet1!$K$5:$K").append("$"+(4+dynamicPos));
        CTBarSer ctBarSer = ctBarChart.addNewSer();
        CTSerTx ctSerTx = ctBarSer.addNewTx();
        CTStrRef ctStrRef = ctSerTx.addNewStrRef();
        ctStrRef.setF("Sheet1!$K$4");
        ctBarSer.addNewIdx().setVal(0);
        CTAxDataSource cttAxDataSource = ctBarSer.addNewCat();
        ctStrRef = cttAxDataSource.addNewStrRef();
       // ctStrRef.setF("Sheet1!$K$5:$K$9"); // set name bottom // dynamic
        ...
        //the line series
        StringBuilder positionCountCell = new StringBuilder().append("Sheet1!$L$5:$L").append("$"+(4+dynamicPos));
        CTLineSer ctLineSer = ctLineChart.addNewSer();
        ctLineSer.addNewSmooth().setVal(false);
        ctSerTx = ctLineSer.addNewTx();
        ctStrRef = ctSerTx.addNewStrRef();
        ctStrRef.setF("Sheet1!$L$4");// set value
